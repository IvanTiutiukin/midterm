...
router.get('/details/add', (req, res, next) => {
  ...
  res.render('books/index', { title: 'Add Book', page: 'books/details', books: ' '});
...
router.get('/details/edit:id', (req, res, next) => {
  ...
  book.findById(id, {}, {}, function(err, editBook)
  {
    if(err)
    {
      console.error(err);
    ...
    res.render('books/index', { title: 'Edit Book', page: 'books/details', book: editBook })
  });
});
